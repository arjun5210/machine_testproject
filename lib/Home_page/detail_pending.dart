...
class detailpendingpage extends StatefulWidget {
  detailpendingpage({required this.id, required this.title});

  String id;
  String title;

  @override
  State<detailpendingpage> createState() => _detailpendingpageState();
}
...
class _detailpendingpageState extends State<detailpendingpage> {
  ...
  void initState() {
    BlocProvider.of<AddBloc>(
      context,
    ).add(detailpendingevent(id: widget.id, title: widget.title));
