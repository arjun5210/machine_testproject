...
import 'package:tisserproject/Home_page/detail_pending.dart';
...
class _pendingpageState extends State<pendingpage> {
  @override
  void initState() {
    BlocProvider.of<AddBloc>(context).add(pendingevent());
